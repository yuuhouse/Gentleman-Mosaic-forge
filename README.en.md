...
Deployment note: Vercel/Netlify only deploy the static frontend. NSFW auto-detection requires the local FastAPI backend launched by `start_app.bat`; the online frontend does not include that inference service by itself.
